...
function mcCar (XX: number, YY: number) {
    ...
    M2 = M2 + XX
    M4 = M4 + XX
    robotbit.MotorRun(robotbit.Motors.M2B, Math.map(Math.constrain(M1, -512, 512), -512, 512, -255, 255))
    robotbit.MotorRun(robotbit.Motors.M2A, Math.map(Math.constrain(M2, -512, 512), -512, 512, -255, 255))
    robotbit.MotorRun(robotbit.Motors.M1A, Math.map(Math.constrain(M3, -512, 512), -512, 512, -255, 255))
    robotbit.MotorRun(robotbit.Motors.M1B, Math.map(Math.constrain(M4, -512, 512), -512, 512, -255, 255))
}
